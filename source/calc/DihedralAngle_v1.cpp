...
double DihedralAngle_v1(vector< AtomDefinition > Molecule, int atom1, int atom2, int atom3, int atom4)
{
	...
	double dot_product = nor_p1[0]*nor_p2[0] + nor_p1[1]*nor_p2[1] + nor_p1[2]*nor_p2[2];

	double temp;

	temp = nor_p1[0]*nor_p1[0] + nor_p1[1]*nor_p1[1] + nor_p1[2]*nor_p1[2];
	double dist_v1 = sqrt(temp);
	temp = nor_p2[0]*nor_p2[0] + nor_p2[1]*nor_p2[1] + nor_p2[2]*nor_p2[2];
	double dist_v2 = sqrt(temp);

	double Pi = 3.1415926535897; // no constant apparently, quick google...

	DihedralAngle = dot_product / (dist_v1*dist_v2);//

	DihedralAngle = acos(DihedralAngle);
	DihedralAngle = DihedralAngle * 180 / Pi;
